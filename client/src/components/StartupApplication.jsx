...
function StartupApplication() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setDocumentsError("Submission failed. Please try again or contact support.");
    } finally {
      setIsSubmitting(false);
    }
  };
                  ...
                  <tr key={i} className="border-t">
                    ...
                    <td className="py-2">
                      {r.status === "verified" ? (
                        ...
                        <span className="text-gray-600 font-semibold">Upload failed ⚠️</span>
                      ) : (
                        <span className="text-gray-600 font-semibold">Error</span>
                      )}
                    </td>
                  </tr>
                ))}
