        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-2xl">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Empowering startups in Ayurveda, Yoga, Unani, Siddha, and
              Homeopathy. Register your innovative healthcare startup and join
              India's traditional medicine revolution.
            </p>
      ...
      <section className="py-16 bg-ayush-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-ayush-100 mb-8 max-w-2xl mx-auto">
            Join thousands of entrepreneurs building the future of traditional
            medicine in India.
          </p>
          <button
            onClick={handleStartRegistration}
            className="bg-white text-ayush-600 hover:bg-gray-100 font-semibold py-4 px-8 rounded-lg text-lg transition-colors duration-200 inline-block"
          >
      ...
      <footer id="contact" className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Empowering traditional medicine startups with modern technology
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 AYUSH Startup Registration Portal. All rights
              reserved.
            </p>
          </div>
        </div>
